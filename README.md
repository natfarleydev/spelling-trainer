...
| Example sentences for concrete words, for example "light", "train" or "garden" | [Tatoeba](https://tatoeba.org), export `eng_sentences_detailed.tsv.bz2` of 2026-09-12. Each sentence keeps its Tatoeba id: `https://tatoeba.org/en/sentences/show/<id>` | [CC BY 2.0 FR](https://creativecommons.org/licenses/by/2.0/fr/) | We expanded contractions (for example, "don't" to "do not") where the data file shows `changed: true`. The mining tools found and scored the sentences, and Claude chose them. | [src/sentences/bank/tatoeba0001.ts](src/sentences/bank/tatoeba0001.ts) |
