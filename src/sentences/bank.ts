...
import { TATOEBA_0009_BANK } from './bank/tatoeba0009'
import { TATOEBA_0010_BANK } from './bank/tatoeba0010'
...
import { WRITTEN_NGSL_0006_BANK } from './bank/writtenNgsl0006'
import { WRITTEN_NGSL_0007_BANK } from './bank/writtenNgsl0007'
import { WRITTEN_NGSL_0008_BANK } from './bank/writtenNgsl0008'
import { WRITTEN_NGSL_0009_BANK } from './bank/writtenNgsl0009'
import { WRITTEN_NGSL_NEXT_0001_BANK } from './bank/writtenNgslNext0001'
import { WRITTEN_NGSL_NEXT_0002_BANK } from './bank/writtenNgslNext0002'
import { WRITTEN_NGSL_NEXT_0003_BANK } from './bank/writtenNgslNext0003'
import { WRITTEN_NGSL_NEXT_0004_BANK } from './bank/writtenNgslNext0004'
...
import { WRITTEN_NGSL_NEXT_0009_BANK } from './bank/writtenNgslNext0009'
import { WRITTEN_NGSL_NEXT_0010_BANK } from './bank/writtenNgslNext0010'
...
import { WRITTEN_PATTERN_RARE_BANK } from './bank/writtenPatternRare'
...
export const BANK_ENTRIES: readonly BankEntry[] = mergeEntries(
  ...
  WRITTEN_PATTERN_RARE_BANK,
  WRITTEN_CYPLEX_BANK,
  WRITTEN_CYPLEX_EXTRA_BANK,
  WRITTEN_EXCEPTION_EXTRA_BANK,
  WRITTEN_NGSL_0001_BANK,
  WRITTEN_NGSL_0002_BANK,
  WRITTEN_NGSL_0003_BANK,
  WRITTEN_NGSL_0004_BANK,
  WRITTEN_NGSL_0005_BANK,
  WRITTEN_NGSL_0006_BANK,
  WRITTEN_NGSL_0007_BANK,
  WRITTEN_NGSL_0008_BANK,
  WRITTEN_NGSL_0009_BANK,
  WRITTEN_NGSL_NEXT_0001_BANK,
  WRITTEN_NGSL_NEXT_0002_BANK,
  WRITTEN_NGSL_NEXT_0003_BANK,
  WRITTEN_NGSL_NEXT_0004_BANK,
  WRITTEN_NGSL_NEXT_0005_BANK,
  WRITTEN_NGSL_NEXT_0006_BANK,
  WRITTEN_NGSL_NEXT_0007_BANK,
  WRITTEN_NGSL_NEXT_0008_BANK,
  WRITTEN_NGSL_NEXT_0009_BANK,
  WRITTEN_NGSL_NEXT_0010_BANK,
